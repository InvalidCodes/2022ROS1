...
if("TRUE" STREQUAL "TRUE")
  set(racebot_control_SOURCE_PREFIX /home/ge/Desktop/ros1/ws_rviz/src/ackermann_gazebo/racebot_control)
  set(racebot_control_DEVEL_PREFIX /home/ge/Desktop/ros1/ws_rviz/devel)
  ...
  set(racebot_control_INSTALL_PREFIX /home/ge/Desktop/ros1/ws_rviz/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'racebot_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ge/Desktop/ros1/ws_rviz/src/ackermann_gazebo/racebot_control/${idir}'.  ${_report}")
    endif()
